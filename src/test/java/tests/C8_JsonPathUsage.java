...
public class C8_JsonPathUsage {
    ...
    public void jsonPathUsage(){
        ...
        System.out.println("Last Name : " + personalInfo.get("lastName"));
        ...
        System.out.println("Phone : " + personalInfo.getJSONArray("phoneNumbers").getJSONObject(0).get("type") + "-"
