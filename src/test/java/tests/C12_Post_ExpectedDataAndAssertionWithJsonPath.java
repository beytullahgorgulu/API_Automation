...
public class C12_Post_ExpectedDataAndAssertionWithJsonPath {
 /*
        When we send a POST request to the URL https://restful-booker.herokuapp.com/booking
        with the body below,
        we should test that the returned response, excluding bookingid, matches the expected structure.
    ...
    @Test
    public void expectedBodyPostTest(){
        ...
        //4- Assertion process (assertEqual(expected,response))
