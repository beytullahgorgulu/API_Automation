...
public class JsonPlaceData {
        ...
        public static JSONObject createExpectedDataForPost22(){
        ...
        public static JSONObject createJsonData (int userId, int id, String title, String body){
            JSONObject expData=new JSONObject();
        ...
        public static Map<String,Object> createBody(){
